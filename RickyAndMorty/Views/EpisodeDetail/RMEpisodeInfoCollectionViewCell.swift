...
//  RickyAndMorty
//
//  Created by Ezgi Karahan on 7.03.2024.
/*
 CELL SINIFI AÇIKLAMASI:
 
 Burada amaç hücrelerin tasarımını ele almak, labelları, sabitlemeleri yapmak.
 */
...
final class RMEpisodeInfoCollectionViewCell: UICollectionViewCell {
    ...
    func configure(with viewModel: RMEpisodeInfoCollectionViewCellViewModel){
        titleLabel.text = viewModel.title //bu özellikler viewodelda vardı.
